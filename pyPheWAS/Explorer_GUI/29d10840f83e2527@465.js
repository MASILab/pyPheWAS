...
function _svg(d3,DOM,width,height,circles,betterPastel,padRadius,icon)
{
  const svg = d3
...
function _betterPastel(){return(
["#b0deff", "#ffd19a", "#fff8a6"]
)}

function _padRadius(){return(
5
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("svg")).define("svg", ["d3","DOM","width","height","circles","betterPastel","padRadius","icon"], _svg);
  main.variable(observer("betterPastel")).define("betterPastel", _betterPastel);
  main.variable(observer("padRadius")).define("padRadius", _padRadius);
  main.variable(observer("height")).define("height", _height);
  main.variable(observer("scale")).define("scale", _scale);
  main.variable(observer("circles")).define("circles", ["d3","scale"], _circles);
  main.variable(observer("icon")).define("icon", _icon);
